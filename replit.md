...
- **Push Notifications**: APNs integration with 12 notification types, personalized per-user timezone.
  ...
  - **Review Escalation & Auto-Complete**: When a will enters `will_review`, members get escalating daily reminders for 3 days. Day 1-2: "Your Circle is waiting for your review." Day 2-3: "Last chance to review — your review will be auto-completed tomorrow." After 3 days: auto-submits `followThrough: 'skipped'` reviews and transitions will to completed. Uses `ackReminderSentAt` as "last reminded at" timestamp (24hr cooldown between reminders). Manual termination of indefinite wills sets both `endDate` and `completionNotificationSentAt` to ensure review pipeline picks them up.
