...
import { ArrowLeft, Crown, Eye, EyeOff, Handshake, Pencil, TrendingUp } from "lucide-react";
      ...
      <div className="h-full overflow-hidden flex flex-col pt-[calc(env(safe-area-inset-top)+3rem)] pb-[calc(env(safe-area-inset-bottom)+1rem)] px-4" style={{ overscrollBehavior: 'none' }}>
        ...
        <div className="flex justify-start mb-4">
          ...
          <div className="text-center mb-2">
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-3 rounded-2xl w-14 h-14 flex items-center justify-center mx-auto mb-2 shadow-lg">
