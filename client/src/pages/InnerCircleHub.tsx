          ...
          <CardContent className="p-6 md:p-8">
            ...
            {willStatus === 'completed' && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6">Your End Room ceremony has finished. Review the final summary to officially close this <em>Will</em>.</p>
                
                <Button className="bg-amber-600 hover:bg-amber-700 mobile-button" onClick={handleViewWillDetails}>
