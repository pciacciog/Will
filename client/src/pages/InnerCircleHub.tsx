              ...
              <div className="text-center py-8">
                ...
                <div className="bg-green-50 rounded-xl p-4 mb-6">
                  <div className="text-sm text-green-700">
                    ...
                    Waiting for committed members to acknowledge completion: <span className="font-semibold">{will?.acknowledgedCount || 0} of {will?.commitments?.length || 0}</span>
                  </div>
                  <div className="text-xs text-green-600 mt-2">
                    All committed members must acknowledge before creating a new Will
                  </div>
                </div>
