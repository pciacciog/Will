...
export default function AcceptInvite() {
  ...
  const typeColor = will.checkInType === 'abstain' ? '#185FA5' : will.checkInType === 'mission' ? '#3C3489' : '#1D9E75';
  const typeColorLight = will.checkInType === 'abstain' ? '#EBF3FB' : will.checkInType === 'mission' ? '#EEEDFE' : '#E1F5EE';
      ...
      >
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div
            ...
            style={{ background: typeColor, borderRadius: 16 }}
          >
            {/* Avatar */}
            <div
                  ...
                  <div key={member.userId}>
                    <div className="flex items-center gap-3 px-4" style={{ paddingTop: 7, paddingBottom: 7 }}>
                      ...
                      <div
                        ...
                        style={{
                          width: 34, height: 34,
                          background: isAccepted ? typeColor : "#D1D5DB",
                        }}
                      >
                      ...
                      {isPending ? (
                        ...
                        <span className="text-xs font-semibold flex-shrink-0" style={{ color: typeColor }}>In</span>
                      ) : null}
                    </div>
                    {!isLast && (
          ...
          <div
            className="flex items-center gap-3 px-4 py-3"
            style={{ background: typeColorLight, borderRadius: 14 }}
          >
            <div
              className="flex items-center justify-center flex-shrink-0"
              style={{ width: 36, height: 36, borderRadius: 10, background: typeColor }}
            >
              {isWeWill ? (
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs leading-snug truncate" style={{ color: typeColor }}>
                {isWeWill
          ...
          {isWeWill && will.sharedWhat && (
            <div
              ...
              style={{ background: typeColorLight, borderRadius: 12 }}
            >
              <p className="text-[10px] font-semibold uppercase tracking-wide mb-1" style={{ color: typeColor }}>
                The commitment
              </p>
              <p className="text-sm font-semibold italic" style={{ color: typeColor }}>
                "{will.sharedWhat}"
              </p>
            </div>
          )}
          ...
          {invite.status === "accepted" && hasMyCommitment && !isExpired && (
            <div className="rounded-2xl p-4 text-center" style={{ backgroundColor: typeColorLight, border: `1px solid ${typeColorLight}` }}>
              <CheckCircle className="w-6 h-6 mx-auto mb-2" style={{ color: typeColor }} />
              <p className="text-sm font-medium" style={{ color: typeColor }}>You already accepted this invite</p>
              <Button
          ...
          {invite.status === "pending" && !isExpired && (
            <div className="flex flex-col gap-2 pt-1">
              ...
              <button
                ...
                style={{ background: typeColor, borderRadius: 14 }}
