        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Inner Circle</h3>
              <p className="text-gray-600 leading-relaxed">Create or join small, intimate groups of 2-4 people who truly care about your success.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Shared Commitment</h3>
              <p className="text-gray-600 leading-relaxed">Set meaningful goals together with clear timelines and personal motivations.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Real Progress</h3>
              <p className="text-gray-600 leading-relaxed">Track your journey together and celebrate milestones as they happen.</p>
            </div>
          </div>
        </div>
      </div>
